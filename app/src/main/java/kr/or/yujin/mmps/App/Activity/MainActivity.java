...
import kr.or.yujin.mmps.App.Class.ForecdTerminationService;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAllPartsCheck.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, AllPartsCheck.class);
        ...
        btnPartsChange.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MainActivity.this, PartsChangeActivity_New.class);
                startActivity(intent);//액티비티 띄우기
            }
        });
        ...
        btnFeederChange.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, FeederChangeActivity.class);
                startActivity(intent);//액티비티 띄우기
            }
        });
    }
    ...
    private void appSettingLoad(){
        ...
        server_ip = setting.getString("serverIP","175.201.212.227");
