...
public class MisCheckActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mis_check);
        ...
        btnSave.setOnClickListener((new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!etPass.getText().toString().equals("1008")){
                    Toast.makeText(MisCheckActivity.this, "비밀번호가 다릅니다.", Toast.LENGTH_SHORT).show();
                    return;
                }

                // 비밀번호 확인
                if (etID.getText().toString().equals("")){
                    Toast.makeText(MisCheckActivity.this, "확인 관리자의 ID를 입력하여 주십시오.", Toast.LENGTH_SHORT).show();
                    return;
                }
