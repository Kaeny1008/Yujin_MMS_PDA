...
public class Feeder_Change extends AppCompatActivity {
        ...
        btnChange.setOnClickListener((new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (etWorker.length() != 0 &&
                    ...
                    Toast.makeText(Feeder_Change.this,"모든 항목이 입력되지 않았습니다.",Toast.LENGTH_SHORT).show();
                    return;
                }
            }
        }));
    ...
    private class getData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            if (ActivityName.equals("App.Activity.FeederChangeActivity"))
                progressDialog = ProgressDialog.show(Feeder_Change.this,
        ...
        protected void onPostExecute (String result){
            ...
            if (result != null){
                ...
                Toast.makeText(Feeder_Change.this, "서버에 접속 할 수 없습니다.\n상세 내용은 로그를 참조 하십시오.", Toast.LENGTH_SHORT).show();
            }
        }
            ...
            try {
                ...
                if (header.equals("saveResult")) {
                    ...
                    if (!item.getString("Result").equals("Success")){
                        Toast.makeText(Feeder_Change.this, mJsonString, Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(Feeder_Change.this, "저장 완료.", Toast.LENGTH_SHORT).show();
                        //저장완료시 컨트롤 초기화
                    ...
                    if (ScanConst.INTENT_USERMSG.equals(intent.getAction())) {
                        ...
                        if(etWorker.length() == 0){
                            ...
                            try{
                                ...
                                Toast.makeText(Feeder_Change.this, "작업지시번호를 스캔하여 주십시오.", Toast.LENGTH_SHORT).show();
                            }
                            return;
                            ...
                            if (mDecodeResult.toString().substring(0, 3).equals("FN-")) {
                                ...
                                Toast.makeText(Feeder_Change.this, "Feeder Serial No.를 스캔하여 주십시오.", Toast.LENGTH_SHORT).show();
                            }
                            return;
