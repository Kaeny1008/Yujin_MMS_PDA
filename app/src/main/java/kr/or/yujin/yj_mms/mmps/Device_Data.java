...
public class Device_Data extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mmps_device_data);
            ...
            public void onClick(View v) {
                ...
                try{
                    if (spnModel.getSelectedItem().toString().length() == 0) {
                        Toast.makeText(Device_Data.this,"Model을 먼저 입력하여 주십시오.",Toast.LENGTH_SHORT).show();
                        return;
                    }
                }catch (Exception e){
                    Toast.makeText(Device_Data.this,"Model을 먼저 입력하여 주십시오.",Toast.LENGTH_SHORT).show();
                ...
                if (spnFactory.getSelectedItem().toString().length() == 0) {
                    Toast.makeText(Device_Data.this,"공장을 먼저 입력하여 주십시오.",Toast.LENGTH_SHORT).show();
                    return;
                }

                try{
                    if (spnWorkLine.getSelectedItem().toString().length() == 0) {
                        Toast.makeText(Device_Data.this,"작업라인을 먼저 입력하여 주십시오.",Toast.LENGTH_SHORT).show();
                        return;
                    }
                }catch (Exception e){
                    Toast.makeText(Device_Data.this,"작업라인을 먼저 입력하여 주십시오.",Toast.LENGTH_SHORT).show();
                ...
                if (spnWorkSide.getSelectedItem().toString().length() == 0) {
                    Toast.makeText(Device_Data.this,"작업면을 먼저 입력하여 주십시오.",Toast.LENGTH_SHORT).show();
                    return;
                }

                if (etMachineNo.getText().toString().length() == 0) {
                    Toast.makeText(Device_Data.this,"Machine No.를 먼저 입력하여 주십시오.",Toast.LENGTH_SHORT).show();
                    return;
                }

                if (etFeederNo.getText().toString().length() == 0) {
                    Toast.makeText(Device_Data.this,"Feeder No.를 먼저 입력하여 주십시오.",Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        btnResultSave.setOnClickListener((new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (saveOK == true && tvPartNo.getText().toString().length() != 0) {
                    ...
                    Toast.makeText(Device_Data.this,"모든 항목이 입력되지 않았습니다.",Toast.LENGTH_SHORT).show();
                    return;
                }
            }
        }));
    ...
    private class getData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            if (ActivityName.equals("App.Activity.DeviceDataActivity"))
                progressDialog = ProgressDialog.show(Device_Data.this,
        ...
        protected void onPostExecute (String result){
            ...
            if (result == null){
                ...
                Toast.makeText(Device_Data.this, "서버에 접속 할 수 없습니다.\n상세 내용은 로그를 참조 하십시오.", Toast.LENGTH_SHORT).show();
            } else {
        ...
        private void showResult (String mJsonString){
            try {
                ...
                if (header.equals("customerList")) {
                    ...
                    Toast.makeText(Device_Data.this, "등록된 고객사가 없습니다.", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(Device_Data.this, "등록된 모델이 없습니다.", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(Device_Data.this, "등록된 공장이 없습니다.", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(Device_Data.this, "등록된 라인이 없습니다.", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(Device_Data.this, "등록된 제조사가 없습니다.", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(Device_Data.this, "조회완료. 추가 등록으로 진행됩니다.", Toast.LENGTH_SHORT).show();
                    ...
                    if (!item.getString("Result").equals("Success")){
                        Toast.makeText(Device_Data.this, mJsonString, Toast.LENGTH_SHORT).show();
                        return;
                    } else {
                        selDDCode = "";
                        selDDMainNo = "";
                        ...
                        Toast.makeText(Device_Data.this, "정상 등록 되었습니다.", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    try {
                        ...
                        if (partInfo.length < 3) {
                            Toast.makeText(Device_Data.this, "바코드 해독에 실패 하였습니다.", Toast.LENGTH_SHORT).show();
                        } else {
