...
public class SMT_Production_Main extends AppCompatActivity {

    private String activityTag = "SMT 생산 Main Activity";

    private ImageButton btn_SMT_Production_Start;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.smt_production_main);

        control_Initialize();
    }

    private void control_Initialize(){
        btn_SMT_Production_Start = (ImageButton) findViewById(R.id.btn_SMT_Production_Start);
        btn_SMT_Production_Start.setOnClickListener(this::tvClick);
    }

    private void tvClick(View v) {
        switch(v.getId()){
            case R.id.btn_SMT_Production_Start:
                Intent intent = new Intent(SMT_Production_Main.this
                        , SMT_Production_Start.class);
    ...
    private class getData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            if (ActivityName.equals("smt_production.SMT_Production_Main"))
                progressDialog = ProgressDialog.show(SMT_Production_Main.this,
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null){
                ...
                Toast.makeText(SMT_Production_Main.this, "서버에 접속 할 수 없습니다.\n상세 내용은 로그를 참조 하십시오.", Toast.LENGTH_SHORT).show();
            }
        }
        ...
        private void showResult(String mJsonString){
            try {
                ...
                if (header.equals("CheckVer")) {
                    ...
                    Toast.makeText(SMT_Production_Main.this, mJsonString, Toast.LENGTH_SHORT).show();
                }
